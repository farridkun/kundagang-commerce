                ...
                <div class="card-body">
                    ...
                    @endif
                        ...
                        <div class="form-group">
                            ...
                            {!! General::selectMultiLevel('parent_id', $categories, ['class'=>'form-control', 'selected' => (!empty(old('parent_id')) ? old('parent_id') : !empty($category['parent_id']) ? $category['parent_id'] : ''), 'placeholder' => '-- Pilih Category --']) !!}
                        </div>
