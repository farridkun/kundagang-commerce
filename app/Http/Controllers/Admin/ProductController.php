...
class ProductController extends Controller
{
    ...
    public function destroy($id)
    {
        ...
        if ($product->delete()) {
            Session::flash('success', 'Product telah berhasil dihapus');
        }
    ...
    public function upload_images(ProductImageRequest $request, $id)
    {
        $product = Product::findOrFail($id);
        ...
        if ($request->has('image')) {
            ...
            if (ProductImage::create($params)) {
                Session::flash('success', 'Image telah berhasil diunggah');
            } else {
                Session::flash('error', 'Image tidak berhasil diunggah');
            }
    ...
    public function remove_image($id)
    {
        ...
        if ($image->delete()) {
            Session::flash('success', 'Image telah berhasil dihapus');
        }
